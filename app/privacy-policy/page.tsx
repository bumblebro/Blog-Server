function page() {
  return (
    <div className="flex flex-col  gap-4 px-4 pb-3 my-[130px] md:my-[105px]   md:max-w-[45rem] mx-auto w-full ">
      <h1 className="text-center text-3xl font-semibold py-6">Privacy Policy</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to wordofmany.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to wordofmany, accessible from{" "}
            <a
              href="http://www.wordofmany.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              http://www.wordofmany.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="http://www.wordofmany.com/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            http://www.wordofmany.com/contact
          </a>
        </li>
      </ul>
    </div>
