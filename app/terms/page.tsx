  ...
  return (
    <div className="flex flex-col  gap-4 px-4 pb-3 my-[130px] md:my-[105px]   md:max-w-[45rem] mx-auto w-full leading-[1.7rem] font-[330] text-black ">
      ...
      <p>
        ...
        of Word of Many&apos;s Website, located at https://www.wordofmany.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Word of Many if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Word of Many, you agreed to
        use cookies in agreement with the Word of Many&apos;s Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Word of Many and/or its licensors own the
        intellectual property rights for all material on Word of Many. All
        intellectual property rights are reserved. You may access this from Word
        of Many for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul className="list-disc pl-10">
        <li>Republish material from Word of Many</li>
        <li>Sell, rent or sub-license material from Word of Many</li>
        <li>Reproduce, duplicate or copy material from Word of Many</li>
        <li>Redistribute content from Word of Many</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Word
        of Many does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Word of Many,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, Word of Many shall not be liable
      ...
      <p>
        Word of Many reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Word of Many a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Word of Many; and (d) the link
      ...
      <p>
        ...
        e-mail to Word of Many. Please include your name, your organization
      ...
      <p>
        No use of Word of Many&apos;s logo or other artwork will be allowed for
